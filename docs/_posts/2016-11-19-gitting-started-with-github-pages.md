...
1. In the repo's [**Settings**](/TCO476-new5/_pages/RepoSettings.html), in the [**GitHub Pages**](/TCO476-new5/_pages/GitHubWSettings.html) section, set (or ensure that) the doc source to _none_.
